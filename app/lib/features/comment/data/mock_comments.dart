  ...
  static List<Comment> from(DateTime now) {
    ...
    return [
      ...
      c(
        'busan-q2',
        '민서',
        '저는 kapt 걷어내고 annotationProcessor 로만 갔더니 됐어요.',
      ...
      c(
        'busan-t1',
        'evan',
        '축하드려요. 3월에 뵀을 때 기획만 있던 게 벌써 배포라니.',
      ...
      c(
        'busan-t2',
        '민서',
        '언어 상관없다고 하셔서 신청합니다. 파이썬으로 풀어요.',
        const Duration(hours: 7),
      ),
      c(
        'busan-t2',
        '지훈',
        '골드면 저는 좀 벅찰까요? 실버 후반쯤 됩니다.',
        const Duration(hours: 5),
      ),
      c(
        'busan-t2',
        'evan',
        '실버여도 괜찮아요. 같이 풀고 풀이만 나누면 됩니다.',
        const Duration(hours: 4),
        isMine: true,
      ),
      c(
        'busan-t3',
        '수민',
        '온천장이면 스테이지원도 괜찮아요. 자리마다 콘센트 있습니다.',
        const Duration(days: 1),
      ),
      ...
      c(
        'busan-t4',
        '도윤',
        '저는 거치대 대신 노트북 받침 접이식 쓰는데 훨씬 가벼워요.',
        const Duration(days: 3),
      ),
      c(
        'busan-t4',
        '수민',
        '멀티탭은 하나 챙기시면 좋습니다. 콘센트 하나로 둘이 씁니다.',
        const Duration(days: 3),
      ),
      ...
      c(
        'seoul-n1',
        '지우',
        '수요일 저녁 좋네요. 퇴근하고 바로 갈 수 있습니다.',
        const Duration(hours: 20),
      ),
      c(
        'seoul-q1',
        '하늘',
        'isPending 은 이름만 바뀐 거라 일괄 치환으로 됐어요. '
            'status 쓰던 곳이 더 손이 갑니다.',
        const Duration(days: 1, hours: 4),
      ),
      c(
        'seoul-q1',
        '서연',
        '저는 페이지 단위로 나눠서 두 주에 걸쳐 올렸습니다.',
      ...
      m(
        'busan-1',
        '민서',
        '몇 시까지 가면 될까요? 조금 늦을 것 같아서요.',
        const Duration(hours: 6),
      ),
      m(
        'busan-1',
        '재현',
        '오시는 대로 앉으시면 됩니다. 자리는 넉넉해요.',
        const Duration(hours: 5),
      ),
      m(
        'busan-1',
      ...
      m('busan-2', '수민', '일광까지 대중교통으로 얼마나 걸리나요?', const Duration(hours: 8)),
      m('busan-3', '도윤', '저녁이라 식사하고 가면 될까요?', const Duration(hours: 4)),
      m(
        'busan-3',
        'evan',
        '네, 다들 먹고 오십니다. 중간에 나가셔도 돼요.',
        const Duration(hours: 3),
        isMine: true,
      ),
      m('seoul-1', '서연', '처음인데 노트북만 들고 가면 되나요?', const Duration(hours: 7)),
      m('seoul-1', '하늘', '네 충분합니다. 멀티탭 있으면 더 좋고요.', const Duration(hours: 6)),

      // 행사 — 신청 전에 확인하는 것들
      e('busan-e1', '수민', '노트북 필수인가요? 태블릿만 있어서요.', const Duration(days: 1)),
      e('busan-e1', '재현', '실습이 있어서 노트북 쪽이 낫습니다.', const Duration(hours: 20)),
      e(
        'busan-e2',
        'evan',
        '비 오면 취소되나요?',
      ...
      e('busan-e2', '도윤', '우천 시 실내로 옮겨서 진행합니다.', const Duration(hours: 9)),
      e('busan-e3', '민서', '참가비는 현장 결제인가요?', const Duration(days: 2)),
    ];
  }
}
