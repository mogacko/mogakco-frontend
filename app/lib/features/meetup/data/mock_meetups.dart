  ...
  static List<Meetup> from(DateTime now) {
    ...
    return [
      ...
      Meetup(
        ...
        host: '태오',
        chapter: Chapter.busan,
        placeName: '토즈 스터디센터 서면점',
        address: '부산광역시 부산진구 중앙대로 692',
        description: '평일 저녁에 조용히 모입니다. 대화는 밖에서만 해요.',
        latitude: 35.1577,
        longitude: 129.0594,
        sessions: [
          MeetupSession(
      ...
      Meetup(
        ...
        host: '준서',
        chapter: Chapter.busan,
        placeName: '부산광역시립시민도서관',
        address: '부산광역시 부산진구 월드컵대로 462',
        description: '도서관이라 무료입니다. 노트북 자리는 3층에 있어요.',
        latitude: 35.1817,
        longitude: 129.0533,
        sessions: [
          MeetupSession(
